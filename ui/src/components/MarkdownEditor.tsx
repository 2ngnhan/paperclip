...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("nclerk-project-mention-chip");
      ...
      link.classList.add("nclerk-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative nclerk-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("nclerk-mdxeditor", !bordered && "nclerk-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "nclerk-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
